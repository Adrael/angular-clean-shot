...
(function () {
    ...
    function Server($log, $http) {
        ...
        function get(resource, successCallback, errorCallback) {
            ...
            // CAREFUL
            // You have to remove this mockup from your real server
            // This condition is for demonstration purposes only!
            if (resource === 'title') {

                successCallback('Hello world!');
